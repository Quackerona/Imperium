<template>
    ...
    <div>
      <img ref="detail" id="detail" src="/pages/about/aboutDetail.png" draggable="false">

			<RouterLink to="/confession"><img ref="meet" id="meet" src="/pages/about/meet.png"></RouterLink>
